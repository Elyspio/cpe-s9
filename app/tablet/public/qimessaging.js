		...
		(function (a, b) {
			...
			(c.parseUri = function (a) {
				...
				(c.uniqueUri = function (a) {
					...
					return (
						"document" in b
							? ((d = d || document.domain), (e = e || (c == "https" && document.location.protocol !== "https:" ? 443 : document.location.port)))
							: ((d = d || "localhost"), !e && c == "https" && (e = 443)),
						(c || "http") + "://" + d + ":" + (e || 80)
					);
				}),
					...
					return (
						...
						this.handshake(function (d, e, f, g) {
							...
							(c.sessionid = d),
								...
								c.transports || (c.transports = c.origTransports = g ? b.util.intersect(g.split(","), c.options.transports) : c.options.transports),
			...
			(a.flashsocket = c),
				...
				(c.prototype.ready = function (a, d) {
					function e() {
						...
						c.loaded ||
							(typeof WEB_SOCKET_SWF_LOCATION == "undefined" && (WEB_SOCKET_SWF_LOCATION = g.join("/")),
							e !== 843 && WebSocket.loadFlashPolicyFile("xmlsocket://" + b.host + ":" + e),
					...
					if (y.ie && y.win) {
						...
						for (var o in c)
							c[o] != Object.prototype[o] &&
								(o.toLowerCase() == "styleclass" ? m.setAttribute("class", c[o]) : o.toLowerCase() != "classid" && m.setAttribute(o, c[o]));
				...
				y = (function () {
					...
					if (typeof j.plugins != a && typeof j.plugins[c] == b)
						(r = j.plugins[c].description),
							r &&
								(typeof j.mimeTypes == a || !j.mimeTypes[e] || !!j.mimeTypes[e].enabledPlugin) &&
								((k = !0),
								(p = !1),
						...
						try {
							...
							s &&
								...
								r && ((p = !0), (r = r.split(" ")[1].split(",")), (q = [parseInt(r[0], 10), parseInt(r[1], 10), parseInt(r[2], 10)])));
						} catch (t) {}
