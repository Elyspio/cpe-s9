...
class Jagi(object):
    ...
    def callback(self, data):
        if data.id == 0:
            ...
            print(console.cyan + "r: [x, y, z]" + console.reset + " : " + console.yellow + "[%s, %s, %s]" % (
                self.right_marker.x, self.right_marker.y, self.right_marker.z) + console.reset)
            ...
            print(console.cyan + "l: [x, y, z]" + console.reset + " : " + console.yellow + "[%s, %s, %s]" % (
                self.left_marker.x, self.left_marker.y, self.left_marker.z) + console.reset)
